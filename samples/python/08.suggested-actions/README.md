...
For all scenarios, including deploying to Azure or testing locally with `ngrok`, please refer to the comprehensive guide:

**[Azure Deployment Guide for Single-Tenant Teams Bot](./DEPLOYMENT-GUIDE.md)**

This guide provides detailed, step-by-step instructions for:
- Deploying the required Azure infrastructure.
- Deploying the bot's code to Azure.
- Running the bot locally and connecting it to Teams with `ngrok`.
